...
## What I'm doing now
- PR #129 REVIEW ADDRESSED (b185c90): all 12 automated-review findings verified-then-fixed with
  regression tests (see ev-pr129-review-fixes); fixups amended into the 10 squashed chunks; every
  inline comment answered with measured evidence. Fuzz 0-new (10 canaries closed); corpus batteries
  0-div; box corpus FLAT. History had been squashed 62->10 logical chunks earlier the same day;
  PR title/body scrubbed of internal names; PR marked ready-for-review by a human (not me).
  REMAINING = owner review/merge; then release.sh minor (0.4.0) and consumer rollout PRs.
