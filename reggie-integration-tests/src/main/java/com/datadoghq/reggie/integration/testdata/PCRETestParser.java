...
/** Parser for PCRE test format. Format: pattern;input;should_match;features */
public class PCRETestParser {
  ...
  public List<TestCase> parse(InputStream stream) throws IOException {
    ...
    try (BufferedReader reader =
      ...
      while ((line = reader.readLine()) != null) {
        ...
        testCases.add(new TestCase(pattern, input, shouldMatch, "PCRE", features));
      }
    }
