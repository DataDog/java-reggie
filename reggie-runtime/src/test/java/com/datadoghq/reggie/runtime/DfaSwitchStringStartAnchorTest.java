...
public class DfaSwitchStringStartAnchorTest {
  ...
  @Test
  void stringStartNotDiluted1() throws Exception {
    assertRoute("(?:\\A-{1,})1?.{3,}", PatternAnalyzer.MatchingStrategy.DFA_SWITCH);
    assertAgrees("(?:\\A-{1,})1?.{3,}", "1-11-");
  }

  @Test
  void stringStartNotDiluted2() throws Exception {
    assertAgrees("(?:\\A-{1,})1?.{3,}", "a-ca1");
  }

  @Test
  void stringStartNotDiluted3() throws Exception {
    assertAgrees("(?:\\A-{1,})1?.{3,}", "a-0cc");
  }

  // ---- Controls ----

  @Test
  void control_stringStartAlternation_matches() throws Exception {
    assertAgrees("\\Ax|y", "zy");
    assertAgrees("\\Ax|y", "xy");
    assertAgrees("\\Ax", "x");
    assertAgrees("\\Ax", "yx");
  }

  @Test
  void control_stringStartAtBeginning() throws Exception {
    assertAgrees("(?:\\A-{1,})1?.{3,}", "-1234");
    assertAgrees("(?:\\A-{1,})1?.{3,}", "--123");
  }
}
