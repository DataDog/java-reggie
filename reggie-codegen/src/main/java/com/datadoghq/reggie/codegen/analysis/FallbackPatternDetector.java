...
public final class FallbackPatternDetector {
   ...
   * ({@code max == -1}) whose child is nullable are rejected: emitting a greedy loop over a
   * nullable child would produce a zero-progress infinite loop in the generated bytecode.
   */
